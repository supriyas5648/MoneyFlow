...
namespace MoneyFlow
{
    public partial class FrmMain2 : Form
    {
        ...
        public FrmMain2(User? currentUser = null)
        {
            ...
            _settingService = new SettingService();
            InitializeComponent();
            menuItemMainFileImportRecords.Click += menuItemMainFileImportRecords_Click;
            menuItemMainFileExportRecords.Click += menuItemMainFileExportRecords_Click;
            LoadDataInListView();
        }
            ...
            EventArgs e)
        {
            ...
            try
            {
                ...
                List<string> validationErrors =
                    _fileService.ValidateRecords(records, _currentUser.UserId);
            ...
            try
            {
                ...
                string query = @"
                    SELECT
                        t.c_transaction_id AS ""Transaction ID"",
                        t.c_transaction_type AS ""Type"",
                        t.c_transaction_category_id AS ""Category ID"",
                        c.c_category_name AS ""Category"",
                        t.c_transaction_amount AS ""Amount"",
                        t.c_transaction_description AS ""Description"",
                        t.c_transaction_date AS ""Date"",
